...
// Is the node an Atrioventricular node related or not as they have different resopnse pattern
enum AVness_enum
{
    AV = 1,
    non_AV = 2
...
struct node_parameters{
        ...
        int index_of_path_activate_the_node;    // The index of the path that activates the node, used to exclude the path from the list of paths that the node affects
        AVness_enum AVness; // Is the node an Atrioventricular node related or not as they have 
