#ifndef _AFLUTTER_DATA_GEN_HPP
#define _AFLUTTER_DATA_GEN_HPP
...
class {
 public:
  ...
  const std::vector<std::string> node_names = {
      ...
      "CS_LA", "AFL_a", "AFL_b",    "fast",   "fast_b",   "AFL_c",
  };

  const std::vector<std::vector<int>> node_int_parameters = {
      {1, 150, 150, 20, 20, 500, 700, 0, 150, 300, 0, 2},
      {1, 150, 150, 100, 100, 9999, 9999, 0, 50, 150, 0, 2},
      {1, 230, 230, 250, 250, 9999, 9999, 0, 350, 230, 0, 1},
      {1, 200, 200, 120, 120, 9999, 9999, 0, 100, 200, 0, 2},
      {1, 440, 440, 120, 120, 9999, 9999, 0, 330, 440, 0, 2},
      {1, 440, 440, 120, 120, 9999, 9999, 0, 330, 440, 0, 2},
      {1, 440, 440, 120, 120, 9999, 9999, 0, 330, 440, 0, 2},
      {1, 360, 360, 120, 120, 9999, 9999, 0, 150, 360, 0, 2},
      {1, 360, 360, 120, 120, 9999, 9999, 0, 150, 360, 0, 2},
      {1, 360, 360, 120, 120, 9999, 9999, 0, 150, 360, 0, 2},
      {1, 440, 440, 120, 120, 9999, 9999, 0, 330, 440, 0, 2},
      {1, 440, 440, 120, 120, 9999, 9999, 0, 330, 440, 0, 2},
      {1, 440, 440, 120, 120, 9999, 9999, 0, 330, 440, 0, 2},
      {1, 440, 440, 120, 120, 9999, 9999, 0, 330, 440, 0, 2},
      {1, 290, 290, 120, 120, 9999, 9999, 0, 180, 290, 0, 2},
      {1, 290, 290, 120, 120, 9999, 9999, 0, 180, 290, 0, 2},
      {1, 290, 290, 120, 120, 9999, 9999, 0, 180, 290, 0, 2},
      {1, 290, 290, 120, 120, 9999, 9999, 0, 180, 290, 0, 2},
      {1, 303, 290, 120, 120, 9999, 9999, 0, 180, 290, 0, 2},
      {1, 290, 290, 120, 120, 9999, 9999, 0, 180, 290, 0, 2},
      {1, 180, 180, 120, 120, 9999, 9999, 0, 150, 200, 0, 2},
      {1, 360, 360, 120, 120, 9999, 9999, 0, 150, 360, 0, 2},
      {1, 360, 360, 120, 120, 9999, 9999, 0, 150, 360, 0, 2},
      {1, 300, 300, 120, 120, 9999, 9999, 0, 150, 300, 0, 2},
      {1, 300, 300, 120, 120, 9999, 9999, 0, 150, 300, 0, 2},
      {1, 300, 300, 120, 120, 9999, 9999, 0, 150, 300, 0, 2},
      {1, 300, 300, 120, 120, 9999, 9999, 0, 150, 300, 0, 2},
      {1, 300, 300, 120, 120, 9999, 9999, 0, 150, 300, 0, 2},
      {1, 300, 300, 120, 120, 9999, 9999, 0, 150, 300, 0, 2},
      {1, 150, 150, 100, 100, 9999, 9999, 0, 150, 200, 0, 1},
      {1, 150, 150, 100, 100, 9999, 9999, 0, 150, 200, 0, 1},
      {1, 380, 380, 10, 10, 9999, 9999, 0, 500, 380, 0, 1},
      {1, 380, 380, 10, 10, 9999, 9999, 0, 500, 380, 0, 1},
      {1, 150, 150, 100, 100, 9999, 9999, 0, 150, 200, 0, 2},
  };
  ...
  const std::vector<position> node_positions = {
      ...
      {296.5, 334.5}, {160.0, 160.0}, {160.0, 250.0}, {167.5, 243.5},
      {168.5, 230.5}, {140.0, 270.0},
  };

  /* Path Data */
  /* matlab name: path_table */
  const std::vector<std::string> path_names = {
      "SA_CT_a",    "CT",       "CT-AFL_a", "SA_OS",    "fast_AV", "SA_Bach",
      ...
      "AFL_c-CT_a", "AFL_a-b",  "OS_fast",  "fast",     "AFL_b-c",
  };

  const std::vector<std::vector<int>> path_int_parameters = {
      {1, 1, 21, 10},  {1, 21, 2, 10},  {1, 2, 30, 5},   {1, 1, 4, 5},
      ...
      {1, 27, 28, 10}, {1, 23, 29, 5},  {1, 34, 21, 10}, {1, 30, 31, 10},
      {1, 4, 32, 10},  {1, 32, 33, 10}, {1, 31, 34, 10},
  };

  const std::vector<std::vector<float>> path_float_parameters = {
      {1, 1, 164, 164, 57, 57, 56.859475903318, 2.260869565217391},
      {3, 3, 28, 28, 28, 28, 84.8999411071645, -3.727272727272727},
      {0.2, 0.2, 96, 96, 96, 96, 19.235384061671343, 1.5277777777777777},
      {1, 1, 135, 135, 44, 44, 43.86342439892262, -1.0666666666666667},
      {1, 1, 14, 14, 47, 47, 14.142135623730951, -7},
      {3.0105024497581794, 3.0105024497581794, 122, 122, 40, 40,
       120.42009799032718, 0.44545454545454544},
      {1, 1, 70, 70, 68, 68, 68.18357573492314, 0.07352941176470588},
      {1, 1, 33, 33, 35, 35, 34.655446902326915, -0.96},
      {1, 1, 47, 47, 47, 47, 46.69047011971501, 0.9411764705882353},
      {2, 2, 16, 16, 16, 16, 32.0624390837628, 0.0625},
      {2, 2, 19, 19, 20, 20, 39.698866482558415, -1.1538461538461537},
      ...
      {4.25440947723653, 4.25440947723653, 20, 20, 20, 20, 85.0881895447306,
       -0.4358974358974359},
      {3.8268786236304906, 3.8268786236304906, 19, 19, 20, 20,
       76.53757247260981, -0.3150684931506849},
      {1, 1, 18, 18, 18, 18, 18.439088914585774, -1.1666666666666667},
      {1, 1, 18, 18, 19, 19, 18.681541692269406, -0.2777777777777778},
      {2, 2, 17, 17, 18, 18, 34.88552708502482, 1.9375},
      {5.7630287176102115, 5.7630287176102115, 19, 19, 20, 20,
       115.26057435220423, 0.14912280701754385},
      {4.589389937671455, 4.589389937671455, 20, 20, 20, 20, 91.7877987534291,
       -7.583333333333333},
      {5.303300858899107, 5.303300858899107, 19, 19, 20, 20, 106.06601717798213,
       -0.5483870967741935},
      {3.944616584663204, 3.944616584663204, 20, 20, 20, 20, 78.89233169326408,
       -1.7},
      {1, 1, 124, 124, 40, 40, 40, 0},
      {1, 1, 36, 36, 35, 35, 34.713109915419565, -1.1304347826086956},
      {2, 2, 58, 58, 56, 56, 111.72287142747452, -1},
      {2, 2, 56, 56, 57, 57, 113.84199576606166, -0.3333333333333333},
      {2, 2, 52, 52, 52, 52, 103.9471019317037, -1.0136986301369864},
      {2, 2, 48, 48, 47, 47, 94.41398201537736, -0.5421686746987951},
      {2, 2, 39, 39, 39, 39, 78.56844150166147, 0.9137931034482759},
      {2, 2, 61, 61, 59, 59, 117.5967686630887, 0.6632653061224489},
      {1.5, 1.5, 42, 42, 42, 42, 62.6498204307083, 6.88888888888889},
      {1, 1, 25, 25, 25, 25, 25, 1.3333333333333333},
      {2, 2, 10, 10, 10, 10, 20.09975124224178, -10},
      {2, 2, 7, 7, 7, 7, 13.038404810405298, -13},
      {1, 1, 33, 33, 33, 33, 32.50384592629001, -65},
  };
  ...
  const std::vector<std::vector<int>> probe_int_parameters = {
      {23, 24}, {1, 4, 23, 24},   {1, 4, 23}, {1, 4},   {29, 30}, {29, 30},
