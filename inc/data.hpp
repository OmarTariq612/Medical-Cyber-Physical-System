...
public:
    ...
    const std::vector<std::string> node_names = {
        "SA", "CT", "AV", "OS", "His_p", "His_m", "His_d", "Bach", "LA_a",
        "LA", "RBB_m", "RBB", "LBB_m", "LBB", "RVA", "LVA", "RV_m", "RV",
        "LV_m", "LV", "CT_a", "RA_a", "RA", "SEP_RV_m", "SEP_RV", "SEP_LV_m", "SEP_LV",
        "CS_LV", "CS_LA", "slow_b", "slow_a", "fast", "fast_b",
    };
    ...
    const std::vector<std::string> path_names = {
        "SA_CT_a", "CT", "slow_AV", "SA_OS", "fast_AV", "SA_Bach", "Bach_LA_a", "LA", "AV_His",
        "His_p", "His_d", "His_RBB", "His_LBB", "RBB", "LBB", "RBB_RV", "LBB_LV", "RV_LV",
        "RV_m", "LV_m", "RV", "LV", "SA_RA_a", "RA", "SEP_RV", "SEP_RV_m", "SEP_LV",
        "SEP_LV_m", "CS_LV", "CS_LA", "slow", "OS_slow", "OS_fast", "fast",
    };
